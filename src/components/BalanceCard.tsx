...
export const BalanceCard: React.FC<BalanceCardProps> = ({
  ...
  // Usa directDebts (dívidas brutas por credor original) para exibição.
  // Isso garante que "devo para Gabi" e "devo para Miguel" apareçam
  // como linhas separadas, sem colapso pelo algoritmo de minimização.
  ...
  return (
    ...
    >
      ...
      {/* Lista de dívidas diretas por credor */}
      {isEven ? (
          ...
          {myDebts.map((debt) => {
            ...
            return (
              <div
                ...
                className="flex justify-between items-center bg-accent-pink/10 p-3.5 rounded-xl border border-accent-pink/20"
              >
          ...
          {myCredits.map((credit) => {
            ...
            return (
              <div
                ...
                className="flex justify-between items-center bg-accent-blue/10 p-3.5 rounded-xl border border-accent-blue/20"
              >
